...
Jeopardy questions likely presented the greatest challenge to all of our models because of their semantic similarity to jokes. While news headlines and food reviews present rather straightforward factual information, Jeopardy questions necessarily point to a punchline, albeit an implicit one that a contestant needs to answer. Jeopardy questions also seem more likely to touch upon vaugely suggestive topics that would appear in jokes but in the other two contexts. As such, the drop in performance seems unsurprising.
